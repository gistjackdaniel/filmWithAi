      ...
      <div className="project-content">
        ...
        <div className="project-meta">
          <div className="meta-item">
            ...
            <span className="meta-value">{project.genre?.join(', ') || '미정'}</span>
          </div>
          <div className="meta-item">
          ...
          <div className="meta-item">
            ...
            <span className="meta-value">{project.participants?.length || 0}명</span>
          </div>
          <div className="meta-item">
            <span className="meta-label">장면:</span>
            <span className="meta-value">{project.scenes?.length || 0}개</span>
          </div>
        </div>
      ...
      <div className="project-footer">
        <div className="project-info">
          ...
          <span className="last-viewed">
            최근 조회: {project.lastViewedAt ? formatDate(project.lastViewedAt) : '없음'}
          </span>
        </div>
      </div>
    </div>
