...
import type { CreateProjectRequest } from '../../shared/types/project';
...
const CreateProjectModal: React.FC<CreateProjectModalProps> = ({ isOpen, onClose }) => {
  const { createProject, generateStory, isLoading, error } = useProjectStore();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.title || !formData.synopsis?.trim() || (formData.genre && formData.genre.length === 0)) {
